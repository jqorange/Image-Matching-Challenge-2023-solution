...
import sys
sys.path.append('../OANetmaster/core')
sys.path.append('../OANetmaster/demo')
# sys.path.append('/kaggle/input/oanetmaster/OANetmaster/core')
# sys.path.append('/kaggle/input/oanetmaster/OANetmaster/demo')
#print('!',sys.path)
...
class LearnedMatcher(object):
    ...
    def infer2(self, corr,corr_idx):
        with torch.no_grad():
            ...
            if self.default_config.use_ratio==0 and self.default_config.use_mutual==0:
                data['sides'] = []
            else:
            ...
            matches = corr_idx[inlier_idx[0], :].cpu().numpy().astype('int32')
            print(y)
            # print("matcher")
            # print(matches)
            # print(matches.shape)
